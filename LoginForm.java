...
public class LoginForm extends javax.swing.JFrame {    
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/1749571237023 (4).png"))); // NOI18N
    ...
    //Verify Log-in attempt by user
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
    String username = txtUsername.getText();
    String password = txtPassword.getText();

        //Open Shoe Inventory Form if correct Credentials
       if (username.equals("admin") && password.equals("1234")) {
           new shoeInventoryForm().setVisible(true);
           this.dispose(); 
       } else {
